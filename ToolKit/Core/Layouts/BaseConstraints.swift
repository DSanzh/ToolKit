...
public extension Constrainable {
    ...
    @discardableResult
    func edges(to view: Constrainable, excluding excludedEdge: LayoutEdge = .none, insets: TKEdgeInsets = .zero, relation: ConstraintRelation = .equal, priority: LayoutPriority = .required, isActive: Bool = true) -> Constraints {
        prepareForLayout()
    ...
    @discardableResult
    func origin(to view: Constrainable, insets: TKEdgeInsets = .zero, relation: ConstraintRelation = .equal, priority: LayoutPriority = .required, isActive: Bool = true) -> Constraints {
        prepareForLayout()
